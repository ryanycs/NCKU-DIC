...
`define EXPECT   "./dat/P1/golden1.dat"
   ...
   `define SCORE      50
   `define DATA_NUM   12     //modefy by yourself
   `define CMD_NUM    5     //modefy by yourself
   `define GOLDEN_NUM 9     //modefy by yourself
   `define End_CYCLE  10000  //modefy by yourself
...
`define EXPECT   "./dat/P2/golden2.dat"
   ...
   `define SCORE      75
   `define DATA_NUM   12     //modefy by yourself
   `define CMD_NUM    8     //modefy by yourself
   `define GOLDEN_NUM 9     //modefy by yourself
   `define End_CYCLE  10000  //modefy by yourself
...
`define EXPECT   "./dat/P3/golden.dat"
   ...
   `define SCORE      100
   `define DATA_NUM   12     //modefy by yourself
   `define CMD_NUM    12     //modefy by yourself
   `define GOLDEN_NUM 13     //modefy by yourself
   `define End_CYCLE  10000  //modefy by yourself
`endif
...
initial
    $readmemh (`EXPECT, expect_mem);
initial
    $readmemb (`CMD,    cmd_mem   );
initial
    $readmemh (`INDEX,  index_mem );
initial
    $readmemh (`KEY,    value_mem );
initial
    $readmemh (`DATA,   data_mem  );
initial begin
    $display(`DATA);
end
